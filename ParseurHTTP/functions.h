...
bool checkObs_Fold(char requete[], int *i, int longueur, Noeud *noeud, int *TAILLE);

bool checkField_Content(char requete[], int *i, int longueur, Noeud *noeud, int *TAILLE);
